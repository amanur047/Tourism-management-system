...
<div class="agile-grids">	
				...
				<div class="agile-tables" style="overflow: scroll;">
...
<?php if($result->status==2)
{
	?><td>Cancelled</td>
<?php } else {?>
<td><a href="manage-bookings.php?bkid=<?php echo htmlentities($result->bookid);?>" onclick="return confirm('Do you really want to cancel booking')" >Cancel</a> / <a href="manage-bookings.php?bckid=<?php echo htmlentities($result->bookid);?>" onclick="return confirm('Do you really want to Confirm booking')" >Confirm</a>
<a href="report1.php?bkid=<?php echo htmlentities($result->bookid);?>"  >View Ticket</a>
...
?></td>
							...
							<td><?php echo htmlentities($result->acc_number);?></td>
								<td><?php echo htmlentities($result->tnx_id);?></td>
